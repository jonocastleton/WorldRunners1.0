...
WR.TextPrefab = function (game_state, name, position, properties) {
    "use strict";
    ...
    WR.TextPrefab.prototype = Object.create(Phaser.Text.prototype);
    WR.TextPrefab.prototype.constructor = WR.TextPrefab;
